 ...
 */
public final class MyIntrospectionUtils {


    private static final Logger log = Logger.getLogger(MyIntrospectionUtils.class.getName());
    ;
    ...
    public static boolean setProperty(Object o, String name, String value,
        ...
        log.info("IntrospectionUtils: setProperty(" +
        ...
        try {
                ...
                if (setter.equals(methods[i].getName())
                    ...
                    if ("java.lang.Integer".equals(paramType.getName())
                        ...
                        try {
                            ...
                            log.info("IntrospectionUtils: Unable to resolve host name:" + value);
                            ok = false;
                        }

                        // Unknown type
                    } else {
                        log.info("IntrospectionUtils: Unknown type " +
                                paramType.getName());
                    }
            ...
            log.warning("IAE " + o + " " + name + " " + value + ex2);
        } catch (SecurityException ex1) {
            log.warning("IntrospectionUtils: SecurityException for " +
                    o.getClass() + " " + name + "=" + value + ")" + ex1);
        } catch (IllegalAccessException iae) {
            log.warning("IntrospectionUtils: IllegalAccessException for " +
                    o.getClass() + " " + name + "=" + value + ")" + iae);
        } catch (InvocationTargetException ie) {
            //ExceptionUtils.handleThrowable(ie.getCause());
            log.warning("IntrospectionUtils: InvocationTargetException for " +
...
//            ExceptionUtils.handleThrowable(ie.getCause());
    ...
    public static Object callMethod1(Object target, String methodN,
        ...
        log.info("IntrospectionUtils: callMethod1 " +
    ...
    public static Object callMethodN(Object target, String methodN,
        ...
        if (m == null) {
            log.info("IntrospectionUtils: Can't find method " + methodN +
        ...
        try {
            ...
            sb.append(")");
            log.info("IntrospectionUtils:" + sb.toString());
            return o;
        } catch (InvocationTargetException ie) {
            //ExceptionUtils.handleThrowable(ie.getCause());
            throw ie;
    ...
    public static Object convert(String object, Class<?> paramType) {
        ...
        if ("java.lang.String".equals(paramType.getName())) {
            ...
            try {
                ...
                log.info("IntrospectionUtils: Unable to resolve host name:" +
                        object);
            }
